...
// Rastan Saga (Taito, 1987), ported from rastan_hw.pas.
// ROM set is MAME `rastan` (src/mame/taito/rastan.cpp). 8 MHz 68000, 4 MHz Z80
// sound CPU (TC0140SYT mailbox), YM2151, single streamed MSM5205 ADPCM,
...
public:
    ...
    const char* title() const override { return "Rastan Saga"; }
...
private:
    ...
    std::array<uint16_t, 0x2000> ram1_{};
    ...
    std::array<uint8_t, 0x10000> adpcm_rom_{};
    uint16_t adpcm_pos_ = 0;
    uint8_t adpcm_val_ = 0;
    bool adpcm_have_val_ = false;
