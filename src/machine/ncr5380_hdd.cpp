...
void Ncr5380Hdd::wrap_raw_hfs() {
    ...
    // (drive 8 in the high word). Prime uses A0 as the IOParam (Plus convention) and finishes through JIODone.
    static const uint8_t kMacScsiDriver[512] = {
        ...
        0x37, 0x7c, 0xff, 0xee, 0x00, 0x10, 0x70, 0xff, 0x4c, 0xdf, 0x1f, 0xfe, 0x2f, 0x38, 0x08, 0xfc,
        0x4e, 0x75,
    };
